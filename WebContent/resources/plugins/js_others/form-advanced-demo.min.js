$(document).ready(function() {
  ...
  ,
  $("#data_4 .input-group.date").datepicker({minViewMode:1,keyboardNavigation:!1,forceParse:!1,autoclose:!0,todayHighlight:!0})
  ,
  ...
  if ($(".back-change")&&$(".back-change").length>0) {
...
for (var selector in config) {
  ...
  $("#ionrange_1").ionRangeSlider({min:0,max:5e3,type:"double",prefix:"&yen;",maxPostfix:"+",prettify:!1,hasGrid:!0})
 ,$("#ionrange_2").ionRangeSlider({min:0,max:10,type:"single",step:.1,postfix:" 克",prettify:!1,hasGrid:!0})
 ,$("#ionrange_3").ionRangeSlider({min:-50,max:50,from:0,postfix:"°",prettify:!1,hasGrid:!0})
 ,$("#ionrange_4").ionRangeSlider({values:["一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","十一月","十二月"],type:"single",hasGrid:!0})
 ,$("#ionrange_5").ionRangeSlider({min:1e4,max:1e5,step:100,postfix:" km",from:55e3,hideMinMax:!0,hideFromTo:!1})
 ,$(".dial").knob();

  if ($("#basic_slider")) $("#basic_slider").noUiSlider({start:40,behaviour:"tap",connect:"upper",range:{min:20,max:80}});
  if ($("#range_slider")) $("#range_slider").noUiSlider({start:[40,60],behaviour:"drag",connect:!0,range:{min:20,max:80}});
  if ($("#drag-fixed")) $("#drag-fixed").noUiSlider({start:[40,60],behaviour:"drag-fixed",connect:!0,range:{min:20,max:80}});
}